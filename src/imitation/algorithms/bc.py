...
class BC:
    ...
    def train(
        ...
        Args:
            total_timesteps: Number of complete passes made through expert data before ending
                training. Provide exactly one of `n_epochs` and `n_batches`.
            callback: Optional callback with no parameters to run at the end of each
                epoch.
